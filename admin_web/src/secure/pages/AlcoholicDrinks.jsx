...
export default function AlcoholicDrinks() {
    ...
    useEffect(() => {
        getRequest(`/api/drink/alcoholic-drinks/${getUserLogin()}`)
    ...
    return loading ?
        <div>
            <Loading />
            <button type="button" class="button" onClick={(e) => navigate("/app/menu/alcoholic-drinks/create")}>
        ...
        :
        <>
            <button type="button" className="butt" onClick={(e) => navigate("/app/menu/alcoholic-drinks/create")}>
