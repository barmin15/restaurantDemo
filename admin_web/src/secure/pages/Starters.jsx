...
export default function Starterts() {
    const navigate = useNavigate();
    const [loading, setLoading] = useState(true);
    const [data, setData] = useState([]);

    useEffect(() => {
        getRequest(`/api/food/starters/${getUserLogin()}`)
    ...
    return loading ?
        <div>
            <Loading />
            <button type="button" class="button" onClick={(e) => navigate("/app/menu/starters/create")}>
        ...
        :
        <>
        <button type="button" className="butt" onClick={(e) => navigate("/app/menu/starters/create")}>
