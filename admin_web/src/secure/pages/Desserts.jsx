...
export default function Desserts() {
    ...
    useEffect(() => {
        getRequest(`/api/food/desserts/${getUserLogin()}`)
    ...
    return loading ?
        <div>
            <Loading />
            <button type="button" class="button" onClick={(e) => navigate("/app/menu/desserts/create")}>
        ...
        :
        <>
            <button type="button" className="butt" onClick={(e) => navigate("/app/menu/desserts/create")}>
