...
export default function NonAlcoholicDrinks() {
    ...
    useEffect(() => {
        getRequest(`/api/drink/non-alcoholic-drinks/${getUserLogin()}`)
    ...
    return loading ?
        <div>
            <Loading />
            <button type="button" class="button" onClick={(e) => navigate("/app/menu/non-alcoholic-drinks/create")}>
        ...
        :
        <>
        <button type="button" className="butt" onClick={(e) => navigate("/app/menu/non-alcoholic-drinks/create")}>
