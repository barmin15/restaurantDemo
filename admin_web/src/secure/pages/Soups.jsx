...
export default function Soups() {
    ...
    useEffect(() => {
        getRequest(`/api/food/soups/${getUserLogin()}`)
    ...
    return loading ?
        <div>
            <Loading />
            <button type="button" class="button" onClick={(e) => navigate("/app/menu/soups/create")}>
        ...
        :
        <>
        <button type="button" className="butt" onClick={(e) => navigate("/app/menu/soups/create")}>
